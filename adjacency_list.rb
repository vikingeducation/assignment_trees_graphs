...
# puts al.linked_list_at_index(0)   # for Bob: 0
# puts al.linked_list_at_index(1)   # for Harry: 4
# puts al.linked_list_at_index(10)  # for Alice: 1
# puts al.linked_list_at_index(15)  # for Adam: 2
