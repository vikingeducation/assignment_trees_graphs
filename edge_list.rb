...
EDGE_LIST = [
  ...
  [Person.new(5 ,'Mich'), Person.new(3 ,'Sam'), 9],
  [Person.new(5 ,'Mich'), Person.new(10 ,'Alice'), 12],
  [Person.new(5 ,'Mich'), Person.new(6 ,'Alok'), 12],
  [Person.new(7 ,'Dan'), Person.new(19 ,'Boris'), 13],
  [Person.new(7 ,'Dan'), Person.new(10 ,'Alice'), 11],
  [Person.new(7 ,'Dan'), Person.new(5 ,'Mich'), 1],
  ...
  [Person.new(13 ,'Xin'), Person.new(5 ,'Mich'), 3],
  ...
  [Person.new(17 ,'Andur'), Person.new(5 ,'Mich'), 17],
